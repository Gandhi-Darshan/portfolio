        ...
        {SKILLS.map((skillCategory) => (
          <button
            ...
            className={`px-4 py-2 text-white rounded-md transition-all duration-300 ${
              selectedCategory === skillCategory.category ? 'bg-blue-600' : 'bg-gray-600'
            }`}
      ...
      <div className="flex flex-wrap justify-center gap-10 p-5">
        {filteredSkills.map((skill, idx) => {
          ...
          return (
            ...
            >
              <div
                className="cursor-pointer transition-all duration-300 hover:-translate-y-5 sm:text-[80px] md:text-[100px] lg:text-[120px]"
